          ...
          <div className="about-detail-row">
            ...
            <div className="about-detail-icon relative group">
              <a
                ...
                rel="noreferrer"
              >
                <div className="absolute -top-4 -left-4 z-10 bg-[#FF0000] text-white px-4 py-2 rounded-2xl font-bold text-sm shadow-xl shadow-red-500/20 transform group-hover:scale-110 transition-transform">
                  500K+ Subscribers
                </div>
          ...
          <div className="about-detail-row about-detail-row-reverse">
            <div className="about-detail-icon relative group">
              <a
                ...
                rel="noreferrer"
              >
                <div className="absolute -top-4 -right-4 z-10 bg-[#1877F2] text-white px-4 py-2 rounded-2xl font-bold text-sm shadow-xl shadow-blue-500/20 transform group-hover:scale-110 transition-transform">
                  267K+ Followers
                </div>
          ...
          <div className="about-detail-row">
            ...
            <div className="about-detail-icon relative group">
              <a
                ...
                rel="noreferrer"
              >
                <div className="absolute -top-4 -left-4 z-10 bg-black text-white px-4 py-2 rounded-2xl font-bold text-sm shadow-xl transform group-hover:scale-110 transition-transform">
                  172.1K+ Followers
                </div>
          ...
          <div className="about-detail-row about-detail-row-reverse">
            <div className="about-detail-icon relative group">
              <a
                ...
                rel="noreferrer"
              >
                <div className="absolute -top-4 -right-4 z-10 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white px-4 py-2 rounded-2xl font-bold text-sm shadow-xl transform group-hover:scale-110 transition-transform">
                  62.8K+ Followers
                </div>
