        ...
        <div className="footer-top">
          <div className="footer-section footer-brand">
            ...
            <p className="footer-description">
              Empowering communities through dialogue, education, and meaningful conversations.
            </p>
          ...
          <div className="footer-section footer-contact">
            ...
            <div className="footer-contact-info">
              ...
              <p className="footer-contact-item">
                ...
                <span className="footer-contact-text">Kigali, Rwanda</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="footer-copyright">
              © {currentYear} Shangazi. All rights reserved.
            </p>
            <div className="footer-credit">
              <span className="footer-credit-label">Web made by</span>
              <a href="https://micorp.pro" target="_blank" rel="noopener noreferrer" className="footer-credit-link">
                <span className="footer-credit-company">Mirror Corporation</span>
                <svg className="footer-credit-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
