        ...
        <div className="site-footer-top">
          <div className="site-footer-brand">
            ...
            <div className="site-footer-socials">
              ...
              <a href="https://www.youtube.com/@shangaziemmaclaudine" target="_blank" rel="noopener noreferrer" className="site-footer-social" aria-label="YouTube">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/shangaziemmaclaudine1/" target="_blank" rel="noopener noreferrer" className="site-footer-social" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.tiktok.com/@shangazi_emmaclaudine" target="_blank" rel="noopener noreferrer" className="site-footer-social" aria-label="TikTok">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.59-.98v7.37c.05 5.82-5.41 10.56-11.02 9.31-4.14-.92-6.78-5.36-5.83-9.45.89-4.13 5.41-6.73 9.44-5.83 1.15.26 2.18.77 3.03 1.51V.02z" />
                </svg>
              </a>
            </div>
          </div>
